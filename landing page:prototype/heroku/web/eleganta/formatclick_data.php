...
$email1= $_GET["d"];
   ...
   $sql1 =<<<EOF
      INSERT INTO formatclick_data (first_name,email)
      VALUES ('$first','$email1');
      UPDATE analysis_data SET ad_conversions = ad_conversions + 1, ad_percentage = (((ad_conversions + 1)*100)/(ad_clicks)) WHERE format_type = 'Format_click';
EOF;
